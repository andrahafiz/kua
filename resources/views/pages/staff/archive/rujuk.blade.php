        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item">Dokumen Rujuk</div>
                </div>
            </div>
                                            ...
                                            @foreach ($documents as $document)
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        {{ $document->married?->akta_nikah_number }}
                                                    </td>
                                                    <td class="align-middle">{{ $document->title_document }}
                                                        {{ $document->type_document }}</td>
                                                    <td class="align-middle">
                                                        <a target="_blank"
                                                            href="{{ asset('storage/documents/' . str_replace('public/documents/', '', $document->type_document . '/' . $document->path_document)) }}">Lihat
                                                            File</a>
                                                    </td>
                                                    <td class="align-middle">
