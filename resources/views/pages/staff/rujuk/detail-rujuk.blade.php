...
@section('main')
    ...
    <div class="main-content">
        <section class="section">
            ...
            <form action="{{ route('staff.rujuk.approval', $rujuk->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-12 col-sm-12 col-lg-22">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <input type="time"
                                                            class="form-control @error('waktu_verifikasi') is-invalid @enderror"
                                                            @readonly($rujuk?->status == 2) id="waktu_verifikasi"
                                                            value="{{ old('waktu_verifikasi', optional($rujuk->tanggal_verifikasi)->format('H:i')) }}"
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-0">
                                                ...
                                                @else
                                                    <label for="berita_acara">Berita Cerai</label>
                                                    <input type="file"
                                                        class="form-control @error('berita_acara') is-invalid @enderror"
                                                        @readonly($rujuk?->status == 2) id="berita_acara" name="berita_acara">
                                                    @error('berita_acara')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                ...
                                <div class="card-footer pt-0">
                                    ...
                                    @if ($rujuk?->status == 2)
                                        <button type="button"
                                            class="btn btn-icon btn-lg icon-left btn-warning btn-block">
                                    ...
                                    @else
                                        ...
                                        <button type="submit" name="action" value="declined"
                                            class="btn btn-icon btn-lg icon-left btn-danger btn-block">
