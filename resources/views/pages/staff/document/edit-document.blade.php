        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Data Dokumen</div>
                </div>
            </div>
            ...
            <div class="section-body">
                ...
                @endif
                <form method="POST" action="{{ route('staff.document.update', $document->id) }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <input type="text" class="form-control" name='number_document'
                                                value="{{ old('number_document') ?? $document->number_document }}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
