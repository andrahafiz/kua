        ...
        <div class="tab-pane fade show active" id="husband" role="tabpanel" aria-labelledby="husband-tab">
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control @error('citizen_husband') is-invalid @enderror"
                        @if ($married->husbands->status > 2) disabled @endif name="citizen_husband">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="nationality_husband"
                        ...
                        @if ($married->husbands->status > 2) disabled @endif
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="date" class="form-control @error('ktp_husband') is-invalid @enderror"
                        @if ($married->husbands->status > 2) disabled @endif id="date_birth_husband"
                        name="date_birth_husband" max="{{ now()->format('Y-m-d') }}"
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <x-martial-status name="status_husband" :selected="$married->husbands->status_husband != null
                        ...
                        : old('status_husband')" :status="$married->husbands->status" />
                </div>
                <div class="form-group col-md-6">
                    ...
                    <x-religion name="religion_husband" :selected="$married->husbands->religion_husband != null
                        ...
                        : old('religion_husband')" :status="$married->husbands->status" />
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <x-education name="education_husband" :selected="$married->husbands->education_husband != null
                        ...
                        : old('education_husband')" :status="$married->husbands->status" />
                </div>
                <div class="form-group col-md-6">
                    ...
                    <x-job name="job_husband" :selected="$married->husbands->job_husband != null
                        ...
                        : old('job_husband')" :status="$married->husbands->status" />
                </div>
            </div>
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('ktp_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="ktp_husband" name="ktp_husband">
                @error('ktp_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('kk_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="kk_husband" name="kk_husband">
                @error('kk_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('akta_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="akta_husband" name="akta_husband">
                @error('akta_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('ijazah_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="ijazah_husband" name="ijazah_husband">
            ...
            <div class="form-group mb-0">
                ...
                <input type="file"
                    ...
                    @if ($married->husbands->status > 2) disabled @endif id="surat_keterangan_wali_nikah_husband"
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('N1_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="N1_husband" name="N1_husband">
                @error('N1_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('N4_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="N4_husband" name="N4_husband">
                @error('N4_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('N2_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="N2_husband" name="N2_husband">
                @error('N2_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('N5_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="N5_husband" name="N5_husband">
                @error('N5_husband')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('akta_cerai_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="akta_cerai_husband"
                    name="akta_cerai_husband">
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('akta_kematian_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="akta_kematian_husband"
                    name="akta_kematian_husband">
                <span class="text-muted">Bagi calon yang berstatus duda/janda</span></span>
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('surat_dispensasi_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="surat_dispensasi_husband"
                    name="surat_dispensasi_husband">
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('rekomendasi_kua_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="rekomendasi_kua_husband"
                    name="rekomendasi_kua_husband">
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('surat_izin_komandan_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="surat_izin_komandan_husband"
                    name="surat_izin_komandan_husband">
            ...
            <div class="form-group mb-0">
                ...
                <input type="file" class="form-control @error('surat_kedutaan_husband') is-invalid @enderror"
                    @if ($married->husbands->status > 2) disabled @endif id="surat_kedutaan_husband"
                    name="surat_kedutaan_husband">
