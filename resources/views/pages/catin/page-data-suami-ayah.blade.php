...
<div class="tab-pane fade" id="father_husband" role="tabpanel" aria-labelledby="father_husband-tab">
    <div class="form-row">
        <div class="form-group col-md-8">
            ...
            <input type="text" name="name_father_husband" @disabled($married->status > 2)
                class="form-control @error('name_father_husband') is-invalid @enderror" @disabled($married->status > 2)
        ...
        <div class="form-group col-md-4">
            ...
            <div class="form-check">
                <input class="form-check-input @error('is_unknown_father_husband') is-invalid @enderror" type="checkbox"
                    value="1" id="is_unknown_father_husband" name="is_unknown_father_husband"
                    @checked(old('is_unknown_father_husband', $married->husbands->is_unknown_father_husband)) @disabled($married->status > 2)>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <select class="form-control @error('citizen_father_husband') is-invalid @enderror"
                id="citizen_father_husband" @disabled($married->status > 2) name="citizen_father_husband"
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="nik_father_husband" id="nik_father_husband"
                class="form-control @error('nik_father_husband') is-invalid @enderror" @disabled($married->status > 2)
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="date" class="form-control" @disabled($married->status > 2) id="date_birth_father_husband"
                name="date_birth_father_husband"
    ...
    <div class="form-row">
        ...
        <input type="text" name="address_father_husband" id="address_father_husband"
            class="form-control @error('address_father_husband') is-invalid @enderror" @disabled($married->status > 2)
