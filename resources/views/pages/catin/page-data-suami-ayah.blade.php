...
<div class="tab-pane fade" id="father_husband" role="tabpanel" aria-labelledby="father_husband-tab">
    <div class="form-row">
        <div class="form-group col-md-8">
            ...
            <input type="text" name="name_father_husband"
                ...
                value="{{ $married->name_father_husband != null ? $married->name_father_husband : old('name_father_husband') }}">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="form-check">
                <input class="form-check-input @error('is_unknown_father_husband') is-invalid @enderror" type="checkbox"
                    ...
                    @checked(old('is_unknown_father_husband', $married->is_unknown_father_husband))>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <select class="form-control @error('citizen_father_husband') is-invalid @enderror"
                ...
                <option value="WNI"
                    {{ $married->citizen_father_husband == 'WNI' || old('citizen_father_husband') == 'WNI' ? 'selected' : '' }}>
                    WNI</option>
                <option value="WNA"
                    {{ $married->citizen_father_husband == 'WNA' || old('citizen_father_husband') == 'WNA' ? 'selected' : '' }}>
                    WNA
                </option>
            </select>
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="nik_father_husband" id="nik_father_husband"
                ...
                @if ($married->status > 2) disabled @endif
                value="{{ $married->nik_father_husband != null ? $married->nik_father_husband : old('nik_father_husband') }}">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="nationality_father_husband" id="nationality_father_husband"
                ...
                @if ($married->status > 2) disabled @endif
                value="{{ $married->nationality_father_husband != null ? $married->nationality_father_husband : old('nationality_father_husband') }}"
        ...
        <div class="form-group col-md-3">
            ...
            <input type="text" name="no_passport_father_husband" id="no_passport_father_husband"
                ...
                @if ($married->status > 2) disabled @endif
                value="{{ $married->no_passport_father_husband != null ? $married->no_passport_father_husband : old('no_passport_father_husband') }}">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" name="location_birth_father_husband" id="location_birth_father_husband"
                ...
                @if ($married->status > 2) disabled @endif
                value="{{ $married->location_birth_father_husband != null ? $married->location_birth_father_husband : old('location_birth_father_husband') }}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="date" class="form-control" @if ($married->status > 2) disabled @endif
                ...
                value="{{ old('date_birth_father_husband', optional($married->date_birth_father_husband)->format('Y-m-d')) }}">
            {{-- value="{{ $married->date_birth_father_husband != null ? $married->date_birth_father_husband->format('Y-m-d') : Carbon\Carbon::parse(old('date_birth_father_husband'))->format('Y-m-d') }}"> --}}
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="religion_father_husband">Agama <span class="text-danger">*</span></label>
            <x-religion name="religion_father_husband" :selected="$married->religion_father_husband != null
                ? $married->religion_father_husband
        ...
        <div class="form-group col-md-6">
            ...
            <x-job name="job_father_husband" :selected="$married->job_father_husband != null ? $married->job_father_husband : old('job_father_husband')" :status="$married->status" />
        </div>
    </div>
    <div class="form-row">
        ...
        <input type="text" name="address_father_husband" id="address_father_husband"
            ...
            @if ($married->status > 2) disabled @endif
            value="{{ $married->address_father_husband != null ? $married->address_father_husband : old('address_father_husband') }}">
