...
<div class="form-row">
    <div class="form-group col-md-2">
        ...
        <select class="form-control @error('citizen_wali') is-invalid @enderror" id="citizen_wali"
            @if ($married->status > 2) disabled @endif name="citizen_wali">
    ...
    <div class="form-group col-md-2">
        ...
        <input type="text" name="nationality_wali" id="nationality_wali"
            class="form-control @error('nationality_wali') is-invalid @enderror"
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="no_passport_wali" id="no_passport_wali"
            class="form-control @error('no_passport_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
    ...
    <div class="form-group col-md-2">
        ...
        <select class="form-control @error('status_wali') is-invalid @enderror" id="status_wali"
            @if ($married->status > 2) disabled @endif name="status_wali">
...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="name_wali" id="name_wali"
            class="form-control @error('name_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="name_father_wali" id="name_father_wali"
            class="form-control @error('name_father_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        ...
        <input type="text" name="location_birth_wali" id="location_birth_wali"
            class="form-control @error('location_birth_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
    ...
    <div class="form-group col-md-3">
        ...
        <input type="date" class="form-control" @if ($married->status > 2) disabled @endif
            id="date_birth_wali" name="date_birth_wali"
...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <input type="text" name="number_phone_wali" id="number_phone_wali"
            class="form-control @error('number_phone_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
...
<div class="form-row">
    <div class="form-group col-md">
        ...
        <input type="text" name="address_wali" id="address_wali"
            class="form-control @error('address_wali') is-invalid @enderror"
            @if ($married->status > 2) disabled @endif
