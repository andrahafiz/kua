        ...
        {{-- <section id="features" class="features">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ asset('landingpage') }}/img/features.png" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row feture-tabs" data-aos="fade-up">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ asset('landingpage') }}/img/features-2.png" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row feature-icons" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
                            <img src="{{ asset('landingpage') }}/img/features-3.png" class="img-fluid p-4"
                                alt="">
                        </div>
                ...
                <div class="row gy-4" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            ...
                            <img src="{{ asset('landingpage') }}/img/pricing-free.png" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            ...
                            <img src="{{ asset('landingpage') }}/img/pricing-starter.png" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box">
                            ...
                            <img src="{{ asset('landingpage') }}/img/pricing-business.png" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="box">
                            ...
                            <img src="{{ asset('landingpage') }}/img/pricing-ultimate.png" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                ...
                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-1.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 1</h4>
                                <p>App</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-1.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-2.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 3</h4>
                                <p>Web</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-2.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-3.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 2</h4>
                                <p>App</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-3.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-4.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 2</h4>
                                <p>Card</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-4.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-5.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 2</h4>
                                <p>Web</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-5.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-6.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>App 3</h4>
                                <p>App</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-6.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-7.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 1</h4>
                                <p>Card</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-7.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-8.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Card 3</h4>
                                <p>Card</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-8.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('landingpage') }}/img/portfolio/portfolio-9.jpg" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4>Web 3</h4>
                                <p>Web</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset('landingpage') }}/img/portfolio/portfolio-9.jpg"
                                        data-gallery="portfolioGallery" class="portfokio-lightbox" title="Web 3"><i
                                            class="bi bi-plus"></i></a>
                                    <a href="portfolio-details.html" title="More Details"><i
                                            class="bi bi-link"></i></a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('landingpage') }}/img/testimonials/testimonials-1.jpg"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('landingpage') }}/img/testimonials/testimonials-2.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('landingpage') }}/img/testimonials/testimonials-3.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('landingpage') }}/img/testimonials/testimonials-4.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('landingpage') }}/img/testimonials/testimonials-5.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('landingpage') }}/img/team/team-1.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('landingpage') }}/img/team/team-2.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('landingpage') }}/img/team/team-3.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('landingpage') }}/img/team/team-4.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="clients-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-1.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-2.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-3.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-4.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-5.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-6.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-7.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('landingpage') }}/img/clients/client-8.png"
                                class="img-fluid" alt=""></div>
                    </div>
                    <div class="swiper-pagination"></div>
                </div>
        ...
        {{-- <section id="recent-blog-posts" class="recent-blog-posts">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('landingpage') }}/img/blog/blog-1.jpg"
                                    class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('landingpage') }}/img/blog/blog-2.jpg"
                                    class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('landingpage') }}/img/blog/blog-3.jpg"
                                    class="img-fluid" alt=""></div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container">
            ...
            <div class="credits">
                ...
                <!-- Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/KUA-bootstrap-startup-template/ -->
