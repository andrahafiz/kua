...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rule = [
            ...
            "photo_husband" => ['required', 'image', 'mimes:png,jpg'],
            ...
            "citizen_wife" => ['required', 'in:WBI,WNA'],
            "nationality_wife" => ['required', 'string'],
            "nik_wife" => ['required_if:nationality_wife,WNI', 'string'],
            "no_passport_wife" => ['required_if:nationality_wife,WNA', 'string'],
            ...
            "old_wife" => ['sometimes', 'nullable', 'numeric'],
            "status_wife" => ['required', 'string'],
            "religion_wife" => ['required', 'string'],
            "religion_wife" => ['required', 'string'],
            "education_wife" => ['required', 'string'],
            "job_wife" => ['required', 'string'],
            "address_wife" => ['required', 'string'],
            "email_wife" => ['required', 'email'],
            "phone_number_wife" => ['sometimes', 'nullable', 'string'],
            "photo_wife" => ['required', 'image', 'mimes:png,jpg'],

            "name_father_wife"               => ['required', 'string'],
            "is_unknown_father_wife"         => ['sometimes', 'nullable', 'string'],
            "citizen_father_wife"            => ['required_unless:is_unknown_father_wife,true', 'in:WNI,WNA'],
            "nationality_father_wife"        => ['required_with:citizen_father_wife', 'string'],
            "nik_father_wife"                => ['required_if:citizen_father_wife,WNI', 'nullable', 'string'],
            "no_passport_father_wife"        => ['required_if:citizen_father_wife,WNA', 'nullable',  'string'],
            "location_birth_father_wife"     => ['required_unless:is_unknown_father_wife,true', 'nullable', 'string'],
            "date_birth_father_wife"         => ['required_unless:is_unknown_father_wife,true', 'nullable', 'date', 'date_format:Y-m-d'],
            "religion_father_wife"           => ['required_unless:is_unknown_father_wife,true', 'nullable', 'string'],
            "job_father_wife"                => ['required_unless:is_unknown_father_wife,true', 'nullable', 'string'],
            "address_father_wife"            => ['required_unless:is_unknown_father_wife,true', 'nullable', 'string'],

            "name_mother_wife"               => ['required', 'string'],
            "is_unknown_mother_wife"         => ['sometimes', 'nullable', 'string'],
            "citizen_mother_wife"            => ['required_unless:is_unknown_mother_wife,true', 'in:WNI,WNA'],
            "nationality_mother_wife"        => ['required_with:citizen_mother_wife', 'string'],
            "nik_mother_wife"                => ['required_if:citizen_mother_wife,WNI', 'nullable', 'string'],
            "no_passport_mother_wife"        => ['required_if:citizen_mother_wife,WNA', 'nullable',  'string'],
            "location_birth_mother_wife"     => ['required_unless:is_unknown_mother_wife,true', 'nullable', 'string'],
            "date_birth_mother_wife"         => ['required_unless:is_unknown_mother_wife,true', 'nullable', 'date', 'date_format:Y-m-d'],
