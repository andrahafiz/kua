...
class PenghuluController extends Controller
{
    ...
    {
        return view(
            'pages.staff.penghulu.tambah-penghulu',
            ['type_menu' => 'penghulu']
        );
    }
    ...
    {
        $params = $request->safe([
            'name_penghulu', 'phone', 'address', 'photo'
        ]);
        ...
        return redirect()->route('staff.penghulu.index');
    }
    ...
    {
        return view(
            'pages.staff.penghulu.edit-penghulu',
    ...
    public function update(PenghuluUpdateRequest $request, Penghulu $penghulu)
    {
        ...
        try {
            ...
            return redirect()->route('staff.penghulu.index')->with('success', "Data user '{$penghulu->name}' berhasil diubah");
        } catch (\Throwable $e) {
    ...
    public function destroy(Penghulu $penghulu)
    {
        ...
        return redirect()->route('staff.penghulu.index')->with('success', "Data user '{$penghulu->name_penghulu}' berhasil dihapus");
    }
}
