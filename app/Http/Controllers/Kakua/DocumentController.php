...
class DocumentController extends Controller
{
    ...
    {
        return view(
            'pages.kakua.document.tambah-document',
            ['type_menu' => 'document']
        );
    }
    ...
    public function store(DocumentCreateRequest $request)
    {
        ...
        return redirect()->route('kakua.document.index');
    }
    ...
    {
        return view(
            'pages.kakua.document.edit-document',
    ...
    public function update(DocumentUpdateRequest $request, Document $document)
    {
        ...
        try {
            ...
            return redirect()->route('kakua.document.index')->with('success', "Data user '{$document->name}' berhasil diubah");
        } catch (\Throwable $e) {
    ...
    public function destroy(Document $document)
    {
        ...
        return redirect()->route('kakua.document.index')->with('success', "Data user '{$document->title}' berhasil dihapus");
    }
}
